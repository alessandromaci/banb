    ...
    <div className="w-full rounded-2xl bg-white/5 border border-white/10 p-6 space-y-4">
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            size="sm"
            variant="ghost"
            className="shrink-0 text-white bg-transparent hover:bg-transparent"
          >
            {copied ? (
      ...
      <div className="rounded-xl bg-amber-500/10 border border-amber-500/20 p-4">
        <p className="text-xs text-amber-200">
          <strong>Important:</strong> Send USDC on Base network only. Transfers
          sent to other networks will not appear on your balance.
        </p>
      </div>
    </div>
  );
